...
const Hero = () => {
  ...
  return (
    <div className='flex lg:flex-row md:flex-row flex-col justify-center items-start lg:min-h-[70vh] md:min-h-[50vh] min-h-[40vh] w-full'>
        <div className='flex flex-col justify-center items-start lg:w-3/5 md:w-4/5 w-full h-full lg:py-[60px] md:py-[30px] py-[10px] lg:pl-[80px] md:pl-[10px] pl-[20px]'>
          <h1 className='lg:text-[60px] md:text-[33px] text-[22px] font-[700] text-[#FD8A6D]'><span className='text-white'>Priya</span> Dwivedi</h1>
          <p className='lg:text-[26px] md:text-[12px] text-[12px] font-semibold'>Frontend Developer</p>
          <p className='lg:text-[22px] md:text-[14px] text-[12px] lg:leading-[35px] md:leading-[25px] leading-[20px] font-light font-[600] lg:py-6 md:py-4 py-2 lg:mr-16 md:mr-8 mr-4'>
        ...
        <div className='lg:w-2/5 md:w-[60%] w-full lg:h-full md:h-full h-[50%]'>
